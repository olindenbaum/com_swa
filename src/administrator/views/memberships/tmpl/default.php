...
<form method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="span10">
		<div id="adminview-description">
			...
			<p>New Members must buy a membership each year. Lifetime members don't have to pay but have to follow the
				same process of selecting their uni and level to gain a membership each year.</p>
		</div>
